...
contract EXO_PublicSale_Elysium  is ReentrancyGuard {
    ...
    function dexBuy(uint256 AmountETH) public returns(uint256) {   // Buy function for elysium chain
        // require(isStart,"Sales has been paused!");
        ...
        // require(rcAmount < publicSupply, "Current Buying exceeding total Supply!");
        // require(totalRCSold < publicSupply, "Exceeding total Supply!");

        // require(totalRCSold + rcAmount < publicSupply, "Exceeding total Supply!");
